...
@section('title', __('trans.edit_user') . ' - ' . $user->name)
...
@section('content')
    ...
    <div class="form-container">
        <div class="glass-card form-card">
            ...
            <form method="POST" action="{{ route('dashboard.users.update', $user) }}" class="user-form">
                @csrf
                @method('PUT')

                <div class="form-header">
                    <h3>{{ __('trans.user_information') }}</h3>
                    <p>{{ __('trans.update_user_information_and_permissions') }}</p>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label for="name" class="form-label">
                            <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24" class="input-icon">
                    ...
                    <div class="form-group">
                        <label for="password" class="form-label">
                            ...
                            <span class="optional">({{ __('trans.optional') }})</span>
                        </label>
                        <div class="input-wrapper">
                            <input type="password" id="password" name="password"
                                class="form-input @error('password') error @enderror"
                                    placeholder="{{ __('trans.leave_blank_to_keep_current_password') }}">
